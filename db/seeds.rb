...
Bookmark.create(url: "https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch", image: "https://imageserver.petsbest.com/website/PetsBestLogo.svg", h1: "Using Fetch - Web APIs | MDN", body: "The Fetch API provides a JavaScript interface for accessing and manipulating parts of the HTTP pipeline, such as requests and responses", user_id: 1)

Bookmark.create(url: "https://www.petsbest.com/dog-owners-guide", image: "https://imageserver.petsbest.com/website/PetsBestLogo.svg", h1: "New Dog Owner’s Guide by Pets Best", body: "The prospect of adding a new puppy to your family can be incredibly exciting. Most dog owners would agree that having a constant, loyal companion who loves them unconditionally brings a tremendous amount of joy to their lives", user_id: 1)

Bookmark.create(url: "https://www.udemy.com/course/react-redux/?ranMID=39197&ranEAID=sQSGk8Sr3fw&ranSiteID=sQSGk8Sr3fw-DxZlpPRrOb7CRgPODE9hHQ&utm_source=aff-campaign&LSNPUBID=sQSGk8Sr3fw&utm_medium=udemyads", image: "https://www.udemy.com/staticx/udemy/images/v6/logo-coral.svg", h1: "Modern React with Redux Training Course | Udemy", body: "Build amazing single page applications with React JS and Redux. Master fundamental concepts behind structuring Redux applications", user_id: 1)

Bookmark.create(url: "https://www.healthline.com/nutrition/ketogenic-diet-101", image: "https://tukuz.com/wp-content/uploads/2020/09/healthline-logo-vector.png", h1: "The Ketogenic Diet: A Detailed Beginner’s Guide to Keto", body: "The ketogenic diet (or keto diet, for short) is a low carb, high fat diet that offers many health benefits.", user_id: 1)

Bookmark.create(url: "https://www.iwillteachyoutoberich.com/guides/ultimate-guide-to-personal-finance/part-0/#part1-money-mistakes-that-cost-you-millions", image: "https://www.iwillteachyoutoberich.com/guides/ultimate-guide-to-personal-finance/part-0/img/part-1.svg", h1: "The Ultimate Guide to Personal Finance: Money Management Made Simple", body: "If you avoid making costly money mistakes, you can save hundreds of thousands – if not millions – of dollars over your lifetime. Knowing what NOT to do with our money is half the battle.", user_id: 1)

Bookmark.create(url: "https://www.lifehack.org/848704/how-to-do-transcendental-meditation", image: "https://cdn.lifehack.org/wp-content/uploads/2019/10/how-to-do-transcendental-meditation-1024x768.jpeg", h1: "How to Do Transcendental Meditation (Step-by-Step Guide)", body: "Meditation was first developed in India many years ago (around 5000-3500 BCE). It took quite some time to become popular in the western world", user_id: 1)

Bookmark.create(url: "https://www.stylesofman.com/mens-summer-fashion/", image: "https://www.stylesofman.com/wp-content/uploads/2019/06/mens-summer-fashion-essentials.jpg", h1: "Men’s Summer Fashion: 2021 Style Trends", body: "With summer on the horizon, we can finally look forward to some much-deserved sunshine, beer gardens, and outdoor adventures", user_id: 1)
